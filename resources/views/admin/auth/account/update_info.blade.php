...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li>
            <a href="{{ route('admin.home') }}">{{ config('backpack.base.project_name') }}</a>
        </li>
        ...
        <form class="form" action="{{ route('admin.account.info') }}" method="post">
            ...
            <div class="box">
                ...
                <div class="box-footer">
                    ...
                    <a href="{{ route('admin.home') }}" class="btn btn-default"><span class="ladda-label">{{ trans('backpack::base.cancel') }}</span></a>
